...
asv_table_filt <- asv_table[grepl("_", rownames(asv_table)), , drop = FALSE]
...
# Save plots.
ggsave("HordeumSynCom_cpcoa_allASVs.pdf", p_allASVs, width=5, height=5)
ggsave("HordeumSynCom_cpcoa_matchedASVsonly.pdf", p_filtASVs, width=5, height=5)
saveRDS(p_allASVs, "HordeumSynCom_cpcoa_allASVs.rds")
saveRDS(p_filtASVs, "HordeumSynCom_cpcoa_matchedASVsonly.rds")
