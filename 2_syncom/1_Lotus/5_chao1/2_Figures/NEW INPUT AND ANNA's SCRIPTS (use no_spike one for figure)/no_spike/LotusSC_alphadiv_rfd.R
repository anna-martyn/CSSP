...
alpha <- read.table("../../1_Scripts/no_spike/allASVs/LotusSC_allASVs_chao1.txt", sep="\t", header=TRUE, row.names=1, check.names=FALSE)
...
# For both dataframes:
# 1. add metadata info
# 2. set genotype and compartment factor levels for
