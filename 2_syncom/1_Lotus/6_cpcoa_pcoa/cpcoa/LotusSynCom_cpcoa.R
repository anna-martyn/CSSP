...
# Save plots.
ggsave("LotusSynCom_cpcoa_allASVs.pdf", p_allASVs, width=5, height=5)
ggsave("LotusSynCom_cpcoa_matchedASVsonly.pdf", p_filtASVs, width=5, height=5)
saveRDS(p_allASVs, "LotusSynCom_cpcoa_allASVs.rds")
saveRDS(p_filtASVs, "LotusSynCom_cpcoa_matchedASVsonly.rds")
