...
# match asv table file accordingly.
asv_table_matched <- asv_table[grepl("_", rownames(asv_table)),,
                               drop = FALSE]

# Define colours for later graph as well as main theme.
# Also, indicate that mutant names shall be italic in legend.
...
fwrite(points, "PCoA_points_Hv.csv", sep = ",")
fwrite(segments, "PCoA_segments_Hv.csv", sep = ",")
fwrite(text_dt, "PCoA_text_Hv.csv", sep = ",")
