...
# Subset to only keep matched ASVs in asv table.
...
# Save final plot.
ggsave("HordeumSynCom_DA_noNodule.pdf", plot = final_plot, 
       width = 21, height = 20, units = "cm")
saveRDS(final_plot, file = "HordeumSynCom_DA_noNodule.rds")
saveRDS(final_plot, file = "../../3_final_figures/HordeumSynCom_DA_noNodule.rds")

saveRDS(p_RA, file = "p_RA_Hv_no_nodule.rds")
