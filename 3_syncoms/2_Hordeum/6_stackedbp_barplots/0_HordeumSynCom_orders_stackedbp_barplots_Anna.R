...
#   "Other"              = "lightgrey"
# )
colors_df <- read.table("../../../0_files/Bacterial_order_colors.csv", header = T, sep = ",", comment.char = "")
colors <- colors_df$Color; names(colors) <- colors_df$Order
...
saveRDS(p1, file="../../3_final_figures/HordeumSC_order_RA_stackedbp.rds")
...
saveRDS(p_sig, file="../../3_final_figures/Hordeum_order_RA_sign_orders_asterisks.rds")
