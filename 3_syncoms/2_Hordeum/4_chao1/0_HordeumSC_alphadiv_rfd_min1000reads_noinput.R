...
# Loading packages
pkg <- c("ggplot2", "data.table", "multcompView")
for(pk in pkg){
...
# Loading data
alpha_filt <- fread(
  "0_chao1_qiime/matchedASVsonly/HordeumSC_matchedASVsonly_chao1.txt"
)
...
saveRDS(
  object = box_plot,
  file = "1_rds_files/HordeumSC_chao1_matchedASVsonly_rfd.rds"
)

ggsave(
  filename = "2_figures/HordeumSC_chao1_matchedASVsonly_rfd.pdf",
  plot = box_plot,
  width = 15,
  height = 6,
  units = "cm"
