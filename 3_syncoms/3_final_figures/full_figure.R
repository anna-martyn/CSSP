...
p4 <- readRDS("../1_Lotus/8_DA_maaslin2/LotusSynCom_DA.rds")
p5 <- readRDS("../2_Hordeum/7_DA_maaslin2/HordeumSynCom_DA.rds")
...
ggsave("SynCom_figure.pdf", final_plot, width = 21, height = 29.7, 
       units = "cm")
