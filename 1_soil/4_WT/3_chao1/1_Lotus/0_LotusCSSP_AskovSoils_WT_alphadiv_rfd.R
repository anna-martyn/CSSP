...
# Filter to only keep WT samples.
...
# Save the plot.
ggsave("LotusCSSP_AskovSoils_WT_chao1_rfd.pdf", p1, width=7, height=5, unit="cm")
saveRDS(p1, file = "LotusCSSP_AskovSoils_WT_chao1_rfd.rds")
saveRDS(p1, file = "../../7_final_figures/LotusCSSP_AskovSoils_WT_chao1_rfd.rds")
