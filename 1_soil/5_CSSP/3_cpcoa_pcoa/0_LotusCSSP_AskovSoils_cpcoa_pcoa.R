...
ggsave("LotusCSSP_AskovSoils_cpcoaRootAll_pcoaRootUF.pdf", CPCoA_PCoA_plot, width = 9, height = 5.5, units = "cm")
saveRDS(CPCoA_PCoA_plot, "LotusCSSP_AskovSoils_cpcoaRootAll_pcoaRootUF.rds")
saveRDS(CPCoA_PCoA_plot, "../6_final_figures/LotusCSSP_AskovSoils_cpcoaRootAll_pcoaRootUF.rds")
...
saveRDS(PCoA_plots, "../6_final_figures/LotusCSSP_AskovSoils_pcoa_all.rds")
...
saveRDS(CPCoA_plots, "../6_final_figures/LotusCSSP_AskovSoils_cpcoa_all.rds")
