...
taxonomy <- fread("../../../1_data/2_Hordeum/HordeumCSSP_AskovSoils_taxonomy_10_4.tsv")
...
fwrite(DA_ASV_amounts, "Hordeum_DA_ASVs_overview.csv")
...
fwrite(DA_ASV_results, "Hordeum_DAanalysis_results.csv")
