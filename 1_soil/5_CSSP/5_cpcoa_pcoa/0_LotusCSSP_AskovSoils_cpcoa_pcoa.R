...
# Perform principal coordinate analysis (PCoA) for each compartment-soil combination, and make the corresponding plots.
...
saveRDS(CPCoA_PCoA_plot, "../8_final_figures/LotusCSSP_AskovSoils_cpcoaRootAll_pcoaRootUF.rds")
