...
index <- subset(index, Compartment %in% c("rhizo","endo"))
...
# Save the plot.
ggsave("Askov_Hordeum_WT_chao1_rfd.pdf", p1, width=7, height=5)
saveRDS(p1, file = "Askov_Hordeum_WT_chao1_rfd.rds")

# Save ANOVA Tukey HSD output file.
write.csv(label_df, file =  "Hordeum_WT_chao1_ANOVA_TukeyHSD_rfd.csv")
