...
points <- cbind(points, design_rhizo_NPK[match(rownames(points), design_rhizo_NPK$SampleID), ])
...
p
# ggsave(paste("Lotus_rhizo_NPK_PCoA.png", sep=""), p, width=pcoa_width, height=pcoa_height)
ggsave(paste("Lotus_rhizo_NPK_PCoA.pdf", sep=""), p, width=pcoa_width, height=pcoa_height)
...
points <- as.data.frame(points)
colnames(points) <- c("x", "y")
points <- cbind(points, design_rhizo_PK[match(rownames(points), design_rhizo_PK$SampleID), ])
colors <- colors[colors$group %in% points$Genotype, ]
points$Genotype <- factor(points$Genotype, levels=colors$group)
...
p <- ggplot(points, aes(x=x, y=y, color=Genotype)) +
  ...
  theme(legend.position="none")
p
# ggsave(paste("Lotus_rhizo_PK_PCoA.png", sep=""), p, width=pcoa_width, height=pcoa_height)
ggsave(paste("Lotus_rhizo_PK_PCoA.pdf", sep=""), p, width=pcoa_width, height=pcoa_height)
...
points <- as.data.frame(points)
colnames(points) <- c("x", "y")
points <- cbind(points, design_rhizo_UF[match(rownames(points), design_rhizo_UF$SampleID), ])
colors <- colors[colors$group %in% points$Genotype, ]
points$Genotype <- factor(points$Genotype, levels=colors$group)
...
p <- ggplot(points, aes(x=x, y=y, color=Genotype)) +
  ...
  theme(legend.position="none")
p
# ggsave(paste("Lotus_rhizo_UF_PCoA.png", sep=""), p, width=pcoa_width, height=pcoa_height)
ggsave(paste("Lotus_rhizo_UF_PCoA.pdf", sep=""), p, width=pcoa_width, height=pcoa_height)
...
points <- as.data.frame(points)
colnames(points) <- c("x", "y")
points <- cbind(points, design_root_NPK[match(rownames(points), design_root_NPK$SampleID), ])
colors <- colors[colors$group %in% points$Genotype, ]
points$Genotype <- factor(points$Genotype, levels=colors$group)
...
p <- ggplot(points, aes(x=x, y=y, color=Genotype)) +
  ...
  theme(legend.position="none")
p
# ggsave(paste("Lotus_root_NPK_PCoA.png", sep=""), p, width=pcoa_width, height=pcoa_height)
ggsave(paste("Lotus_root_NPK_PCoA.pdf", sep=""), p, width=pcoa_width, height=pcoa_height)
...
points <- as.data.frame(points)
colnames(points) <- c("x", "y")
points <- cbind(points, design_root_PK[match(rownames(points), design_root_PK$SampleID), ])
colors <- colors[colors$group %in% points$Genotype, ]
points$Genotype <- factor(points$Genotype, levels=colors$group)
...
p <- ggplot(points, aes(x=x, y=y, color=Genotype)) +
  ...
  theme(legend.position="none")
p
# ggsave(paste("Lotus_root_PK_PCoA.png", sep=""), p, width=pcoa_width, height=pcoa_height)
ggsave(paste("Lotus_root_PK_PCoA.pdf", sep=""), p, width=pcoa_width, height=pcoa_height)
...
points <- as.data.frame(points)
colnames(points) <- c("x", "y")
points <- cbind(points, design_root_UF[match(rownames(points), design_root_UF$SampleID), ])
colors <- colors[colors$group %in% points$Genotype, ]
points$Genotype <- factor(points$Genotype, levels=colors$group)
...
p <- ggplot(points, aes(x=x, y=y, color=Genotype)) +
  ...
  theme(legend.position="none")
p
# ggsave(paste("Lotus_root_UF_PCoA.png", sep=""), p, width=pcoa_width, height=pcoa_height)
ggsave(paste("Lotus_root_UF_PCoA.pdf", sep=""), p, width=pcoa_width, height=pcoa_height)
