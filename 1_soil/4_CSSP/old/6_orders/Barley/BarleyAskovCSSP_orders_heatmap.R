...
ggsave(paste("BarleyCSSP_heatmap_orders_above1perc.png", sep=""), p1, width=14, height=13)
ggsave(paste("BarleyCSSP_heatmap_orders_above1perc.pdf", sep=""), p1, width=14, height=13)
