...
points <- cbind(points, design_rhizo[match(rownames(points), design_rhizo$Sample_ID), ])
...
ggsave(paste("cpcoa_Genotype_Soil_Barley_rhizo_NEW.png", sep=""), p1, width=10, height=8)
ggsave(paste("cpcoa_Genotype_Soil_Barley_rhizo_NEW.pdf", sep=""), p1, width=10, height=8)
...
points <- cbind(points, design_root[match(rownames(points), design_root$Sample_ID), ])
...
ggsave(paste("cpcoa_Genotype_Soil_Barley_root_NEW.png", sep=""), p2, width=10, height=8)
ggsave(paste("cpcoa_Genotype_Soil_Barley_root_NEW.pdf", sep=""), p2, width=10, height=8)
