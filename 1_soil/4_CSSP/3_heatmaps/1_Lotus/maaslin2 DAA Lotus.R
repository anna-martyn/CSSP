...
p_tax <- ggplot(tax_bar, aes(x=ASV_ID, y=1, fill=Order)) +
  geom_tile() +
  scale_fill_manual(values = colors_orders, drop=FALSE) +
  theme_void() +
...
saveRDS(heatmap, "Heatmap_Lj.rds")
saveRDS(bar_plot, "RA_Barplot_Lj.rds")
saveRDS(p_tax, "Taxonomy_Lj.rds")
saveRDS(p_axis_title, "Axis_title_Lj.rds")
